...
export const MOCK_AI_MODELS: AiModel[] = [
  ...
  },
  {
    ...
    unit: 'image',
    speed: 'fast',
    description: 'Inpaint masked regions with prompt-driven or reference-image fill. Best overall edge blending.',
  },
  {
    id: 'm-sd-inpaint',
    provider: 'stability',
    name: 'Stable Diffusion 3.5 Inpaint',
    version: '3.5',
    capability: 'inpaint',
    costPerUnit: 0.04,
    unit: 'image',
    speed: 'balanced',
    description: 'Open-weights inpainting model — flexible prompt control over masked areas.',
  },
  {
    id: 'm-runway-erase',
    provider: 'runway',
    name: 'Runway Erase & Replace',
    version: '2.0',
    capability: 'inpaint',
    costPerUnit: 0.08,
    unit: 'image',
    speed: 'balanced',
    description: 'Erase objects or replace them via prompt or reference image. Tuned for content-aware fills.',
  },
  {
    id: 'm-adobe-removal',
    provider: 'adobe',
    name: 'Firefly Object Removal',
    version: '3.0',
    capability: 'remove_object',
    costPerUnit: 0.03,
    unit: 'image',
    speed: 'fast',
    description: 'Pure object removal — preserves background detail without prompt or replacement.',
  },
  {
    id: 'm-clipdrop-cleanup',
    provider: 'clipdrop',
    ...
    unit: 'image',
    speed: 'fast',
    description: 'Fast, free-tier clean removal — best for small to medium masked areas on simple backgrounds.',
  },
  {
    id: 'm-elevenlabs',
    provider: 'elevenlabs',
...
export const MOCK_SCENES: Scene[] = [
  {
    ...
    startFrame: {
      mode: 'generate',
      description: 'Wide shot of the empty stone street at golden sunset, warm cinematic light bleeding across cobblestones',
      assetId: 'asset-7',
      prompt: 'old stone street at golden hour, cinematic 35mm, warm rim light, atmospheric',
    },
    endFrame: {
      mode: 'generate',
      description: 'Hero pauses mid-step, looking off-frame as the lamp flickers on; sun now low behind him',
      assetId: 'asset-8',
      prompt: 'silhouette of hero on stone street, low-angle, sun behind him, lamp glow, cinematic 35mm',
    },
  },
  {
    id: 'scene-002',
    ...
    durationSec: 6,
    generationMode: 'prepare_then_generate',
    background: { mode: 'generate', description: 'narrow alley at twilight, soft mist', assetId: 'asset-7' },
    ...
    objects: [
      ...
      },
      {
        ...
        prompt: 'Aram crouched on damp cobblestones, hand reaching for a folded letter, cinematic 50mm',
        assetId: 'asset-1',
        status: 'ready',
        locked: false,
      },
      {
        ...
        prompt: 'aged paper envelope with red wax seal, soft focus, close-up macro lens',
        assetId: 'asset-3',
        status: 'ready',
        locked: false,
      },
    ],
    narration: { text: '"It was addressed to him, but written long before he was born."', voiceRef: 'asset-6' },
    audio: {
      backgroundMusic: { mode: 'generate', genre: 'cinematic ambient', tempo: 'slow', assetId: 'asset-9' },
    ...
    review: { status: 'prepared', lockedAssets: ['asset-7'] },
    costEstimate: 48,
    thumbnailUrl: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=400',
    startFrame: {
      mode: 'generate',
      description: 'Hero turns into the alley, mist curling around his coat, twilight overhead',
      assetId: 'asset-7',
      prompt: 'narrow alley at twilight with hero entering, soft mist, cinematic 50mm',
    },
    endFrame: {
      mode: 'generate',
      description: 'Hero rises with the letter in hand, the red wax seal catching the lamplight',
      assetId: 'asset-3',
      prompt: 'hero standing in alley holding aged letter, wax seal in focus, dramatic, 50mm',
    },
  },
  {
    id: 'scene-003',
    ...
    durationSec: 7,
    generationMode: 'prepare_then_generate',
    background: { mode: 'generate', description: 'dim apartment, blue moonlight', assetId: 'asset-8' },
    ...
    objects: [
      {
        id: 'obj-bg-3',
        type: 'background',
        name: 'Moonlit Apartment',
        description: 'dim apartment, blue moonlight through blinds',
        prompt: 'dim apartment interior, blue moonlight through blinds, 24mm wide, atmospheric',
        assetId: 'asset-8',
        status: 'ready',
        locked: true,
      },
      {
        ...
        type: 'character',
        name: 'Aram (Hero)',
        description: 'standing motionless by the window, phone to ear',
        prompt: 'Aram silhouetted against blinds, phone pressed to ear, tense posture, cinematic',
        assetId: 'asset-1',
        status: 'ready',
        locked: false,
      },
      {
        ...
        description: 'glowing dial visible in the dark',
        prompt: 'vintage rotary phone, glowing dial, moonlight catches the chrome',
        assetId: 'asset-2',
        status: 'ready',
        locked: false,
      },
    ],
    narration: { text: '"Whoever you are, leave it where you found it."', voiceRef: 'asset-6' },
    audio: {
      backgroundMusic: { mode: 'generate', genre: 'thriller score', tempo: 'tense', assetId: 'asset-5' },
    ...
    review: { status: 'prepared', lockedAssets: ['asset-8'] },
    costEstimate: 56,
    thumbnailUrl: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=400',
    startFrame: {
      mode: 'generate',
      description: 'Hero stands silhouetted by the blinds, phone ringing on the table behind him',
      assetId: 'asset-8',
      prompt: 'wide shot of dim apartment, hero silhouette at window, phone on table, blue moonlight',
    },
    endFrame: {
      mode: 'generate',
      description: 'Close on hero hanging up, expression hardened, moonlight on his face',
      assetId: 'asset-10',
      prompt: 'close-up of hero hanging up phone, jaw set, moonlight rim light, cinematic 24mm',
    },
  },
];
...
export const MOCK_PROJECTS: CreativeContract[] = [
  ...
  },
  {
    ...
    finalVideo: {
      ...
      progress: 100,
      uri: 'https://test-videos.co.uk/vids/bigbuckbunny/mp4/h264/360/Big_Buck_Bunny_360_10s_1MB.mp4',
      thumbnailUri: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=600',
      durationSec: 90,
      renderedAt: '2026-05-06T09:12:00Z',
      jobId: 'job-final-003',
    },
  },
];
