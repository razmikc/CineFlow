...
@Component({
  ...
  styles: [
    `
      ...
      .dialog { width: min(960px, 100%); max-height: 92vh; display: flex; flex-direction: column; background: rgba(var(--surface-rgb), 0.96); border: 1px solid var(--border); border-radius: 16px; overflow: hidden; box-shadow: 0 24px 60px rgba(0,0,0,0.45); }
      ...
      .tab-bar { display: flex; gap: 0.3rem; padding: 0.55rem 1.1rem 0; border-bottom: 1px solid var(--border); background: rgba(var(--surface-rgb),0.55); }
      ...
      .tab-btn.active { background: rgba(var(--surface-rgb),0.96); border-color: var(--border); color: var(--text-1); }

      .tmpl-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 0.7rem; padding: 0.7rem 0; }
      .tmpl-card { text-align: left; background: rgba(var(--surface-rgb), 0.55); border: 1px solid var(--border); border-radius: var(--r-md); padding: 0.85rem 0.95rem 0.95rem; cursor: pointer; display: flex; flex-direction: column; gap: 0.35rem; color: var(--text-1); transition: border-color 0.15s, transform 0.15s; }
      ...
      .filter-row { padding: 0.6rem 1.1rem; display: flex; gap: 0.6rem; align-items: center; justify-content: space-between; border-bottom: 1px solid var(--border); background: rgba(var(--surface-rgb),0.6); flex-wrap: wrap; }
      .filter-input { flex: 1 1 260px; max-width: 360px; background: rgba(var(--surface-rgb), 0.55); border: 1px solid var(--border); border-radius: 999px; padding: 0.38rem 0.85rem; font-size: 0.85rem; color: var(--text-1); }
      ...
      .section-nav-v { border-right: 1px solid var(--border); background: rgba(var(--surface-rgb),0.5); padding: 0.6rem 0.45rem; overflow-y: auto; }
      ...
      .sec { padding: 0.7rem 0 0.4rem; border-bottom: 1px dashed rgba(var(--wash-rgb), 0.06); }
